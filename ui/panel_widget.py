"""统一面板 QWidget 基类 - 提供一致的标题栏、刷新按钮、关闭按钮

用于 QWidget 类型的面板（嵌入用），如记忆面板、角色卡。
与 PanelWindow (QDialog) 类似，但使用 QWidget。
"""
...
class PanelWidget(QWidget):
    ...
    close_requested = Signal()  # 关闭按钮点击
    
    def __init__(self, title: str, parent=None, 
                 show_refresh: bool = True, 
                 show_close: bool = True,
                 min_size: tuple = (360, 400),
                 max_size: tuple = (600, 800)):
        ...
        # 卡片容器
        self._card = QFrame()
        self._card.setObjectName("panelWidgetCard")
    ...
    def _create_header(self) -> QWidget:
        """创建统一的标题栏"""
        header = QFrame()
        header.setObjectName("panelWidgetHeader")
        ...
        title_label.setObjectName("panelWidgetTitle")
        ...
        if self._show_refresh:
            ...
            refresh_btn.setObjectName("panelWidgetRefreshBtn")
        ...
        if self._show_close:
            ...
            close_btn.setObjectName("panelWidgetCloseBtn")
    ...
    def _build_qss(self) -> str:
        ...
        return f"""
            ...
            #panelWidgetRefreshBtn, #panelWidgetCloseBtn {{
    ...
    def set_title(self, title: str):
        ...
        for child in self._card.findChildren(QLabel):
            if child.objectName() == "panelWidgetTitle":
                child.setText(title)
                break
